...
$sentence = $connect->prepare( "INSERT INTO tr_staffs (tr_id,tr_staff,tr_lang,tr_designation,tr_name) VALUES (null, :tr_staff, :tr_lang, :tr_designation, :tr_name)");

$sentence->execute(array(
		':tr_staff' => $id_staff,
		':tr_lang' => $lang,
		':tr_designation' => $staff['tr_designation'],
