...
$statment = $connect->prepare(
	'UPDATE testimonials SET testimonial_id = :testimonial_id, testimonial_name = :testimonial_name, testimonial_description = :testimonial_description, testimonial_designation = :testimonial_designation, testimonial_status = :testimonial_status, testimonial_lang = :testimonial_lang, testimonial_image = :testimonial_image WHERE testimonial_id = :testimonial_id'
	);
