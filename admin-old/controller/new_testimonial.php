...
$testimonial_designation = cleardata($_POST['testimonial_designation']);
...
$statment = $connect->prepare("INSERT INTO testimonials (testimonial_id, testimonial_name, testimonial_description, testimonial_designation, testimonial_image, testimonial_status, testimonial_lang) VALUES (null, :testimonial_name, :testimonial_description, :testimonial_designation, :testimonial_image, :testimonial_status, :testimonial_lang)");

$statment->execute(array(
		':testimonial_name' => $testimonial_name,
		':testimonial_description' => $testimonial_description,
		':testimonial_designation' => $testimonial_designation,
