...
$servicespages = get_pages_by_template($connect, $settings['st_language'], 'services');
$certificatespages = get_pages_by_template($connect, $settings['st_language'], 'certificates');
