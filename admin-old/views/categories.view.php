                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                    <?php foreach($categories as $tp): ?>
                      <tr>
                       <td><?php echo $tp['category_id']; ?></td>
                       <td><?php echo echoOutput($tp['tr_name']); ?></td>
                       <td align="right" width="50px" class="padding-right-5">
                        ...
                        <div class="dropdown listing-page">
                          ...
                          <div class="dropdown-menu" aria-label="dropdownMenuButton">
                            ...
                            <?php
                            $languages = get_languages_by_category($connect, $tp['category_id']);
                            foreach ($languages as $language){
                            ?> 
                              <a class="dropdown-item" href="../controller/edit_category.php?lang=<?php echo $language['language_code']; ?>&id=<?php echo $tp['category_id']; ?>"><?php echo $language['language_name']; ?></a>
                            <?php } ?>
                          </div>
                        </div>
                      ...
                      <td align="left" width="50px" class="padding-left-0">
                        <a class="btn btn-small btn-danger btn-delete deleteItem" data-url="../controller/delete_category.php?id=<?php echo $tp['category_id']; ?>">
...
<div id="add_data_Modal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-body">
    <form enctype="multipart/form-data" method="post" id="insertCategories">
