                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                    <?php foreach($zones as $zone): ?>
                      <tr>
                       <td><?php echo $zone['pt_zone_id']; ?></td>
                       <td><?php echo echoOutput($zone['tr_name']); ?></td>
                       <td><?php echo echoOutput($zone['city_name']); ?></td>
                       <td align="right" width="50px" class="padding-right-5">
                        ...
                        <div class="dropdown listing-page">
                          ...
                          <div class="dropdown-menu" aria-label="dropdownMenuButton">
                            ...
                            <?php
                            $languages = get_languages_by_zone($connect, $zone['pt_zone_id']);
                            foreach ($languages as $language) {
                            ?>

                              <a class="dropdown-item" href="../controller/edit_zone.php?lang=<?php echo $language['language_code']; ?>&id=<?php echo $zone['pt_zone_id']; ?>"><?php echo $language['language_name']; ?></a>
                            <?php } ?>
                          </div>
                        </div>
                      ...
                      <td align="left" width="50px" class="padding-left-0">
                        <a class="btn btn-small btn-danger btn-delete deleteItem" data-url="../controller/delete_zone.php?id=<?php echo $zone['pt_zone_id']; ?>">
