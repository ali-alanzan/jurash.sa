                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                    <?php foreach($status as $st): ?>
                      <tr>
                       <td><?php echo $st['pt_status_id']; ?></td>
                       ...
                       <td align="right" width="50px" class="padding-right-5">
                        ...
                        <div class="dropdown listing-page">
                          ...
                          <div class="dropdown-menu" aria-label="dropdownMenuButton">
                            ...
                            <?php
                            $languages = get_languages_by_status($connect, $st['pt_status_id']);

                            foreach ($languages as $language){
                              ?> 
                              <a class="dropdown-item" href="../controller/edit_status.php?lang=<?php echo $language['language_code']; ?>&id=<?php echo $st['pt_status_id']; ?>"><?php echo $language['language_name']; ?></a>
                            <?php } ?>
                          </div>
                        </div>
                      ...
                      <td align="left" width="50px" class="padding-left-0">
                        <a class="btn btn-small btn-danger btn-delete deleteItem" data-url="../controller/delete_status.php?id=<?php echo $st['pt_status_id']; ?>">
