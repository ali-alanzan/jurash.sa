                ...
                <div class="form-row">
                  <div class="form-group col-md-9">
                    <div class="block col-md-12">
                     ...
                     <input type="text" value="<?php echo $staff['staff_email']; ?>" name="staff_email" class="form-control" required="">

                     <label><?php echo _PHONE; ?></label>
                     <input type="text" value="<?php echo $staff['staff_phone']; ?>" name="staff_phone" class="form-control" required="">

                     <label><?php echo _LICENSENUMBER; ?></label>
                     <input type="text" value="<?php echo $staff['staff_license_no']; ?>" name="staff_license_no" class="form-control">

                     <label><?php echo _ADVERTISERNUMBER; ?></label>
                     <input type="text" value="<?php echo $staff['staff_advertiser_no']; ?>" name="staff_advertiser_no" class="form-control">

                     <label><?php echo _WHATSAPP; ?></label>
                     <input type="text" value="<?php echo $staff['staff_whatsapp']; ?>" name="staff_whatsapp" class="form-control">
                     ...
                     <input type="text" value="<?php echo $staff['staff_instagram']; ?>" name="staff_instagram" class="form-control">

                     <label><?php echo _TABLEFIELDDESIGNATION; ?></label>
                     <input type="text" value="<?php echo $staff['tr_designation']; ?>" name="tr_designation" class="form-control">
