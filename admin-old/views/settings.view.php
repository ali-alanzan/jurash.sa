    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-12">
        ...
        <div class="table-responsive">
          <?php if ($check_access['user_role'] == 1 || $check_access['user_role'] == 2){?>
          <fieldset>
          ...
          <fieldset id="pages">
            ...
            <table class="display table s-table">
              ...
              <tr>  
                <td>
                  <label><?php echo _DEFAULTSERVICESPAGE; ?></label>

                  <select class="custom-select form-control" name="st_defaultservicespage">
                    <option value>-</option>
                    <?php
                    foreach($servicespages as $page)
                    {
                      if($settings['st_defaultservicespage'] == $page['page_id'])
                      {
                        echo '<option value="'.$settings['st_defaultservicespage'].'" selected="selected">'.$page['tr_title'].'</option>';
                      }
                      else
                      {
                        echo '<option value="'.$page['page_id'].'">'.$page['tr_title'].'</option>';
              ...
              <tr>  
                <td>
                  <label><?php echo _DEFAULTCERTIFICATESPAGE; ?></label>

                  <select class="custom-select form-control" name="st_defaultcertificatespage">
                    <option value>-</option>
                    <?php
                    foreach($certificatespages as $page)
                    {
                      if($settings['st_defaultcertificatespage'] == $page['page_id'])
                      {
                        echo '<option value="'.$settings['st_defaultcertificatespage'].'" selected="selected">'.$page['tr_title'].'</option>';
                      }
                      else
                      {
                        echo '<option value="'.$page['page_id'].'">'.$page['tr_title'].'</option>';
          ...
          <fieldset>
            ...
            <table class="display table s-table">
              ...
              <tr>  
                <td>
                  <label><?php echo _ARABICOFFICEADDRESS; ?></label>
                  <input class="form-control" value="<?php echo $settings['st_arabic_officeaddress']; ?>" name="st_arabic_officeaddress" type="text">
                </td>
              </tr>
