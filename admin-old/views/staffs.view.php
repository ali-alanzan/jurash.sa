                  ...
                  <table class="display table table-striped">
                            ...
                            <tbody>
                                <?php foreach($staffs as $staff): ?>
                                    <tr>
                                       ...
                                       <td class="product">
                                        ...
                                        if (!empty($staff['staff_image'])) {
                                            echo '<img class="product-img product-img-p" src="../../images/'.$staff['staff_image'].'">';
                                        }else{
                                            echo '<img class="product-img product-img-p" src="../assets/images/avatar.png">';
                                        }
                                        ?>
                                    </td>
                                       <td><?php echo $staff['tr_name']; ?></td>
                                    ...
                                    <td align="right" width="50px" class="padding-right-5">
                                        ...
                                        <div class="dropdown-menu" aria-label="dropdownMenuButton">
                                            ...
                                            <?php
                                            $languages = get_languages_by_staff($connect, $staff['staff_id']);
                                            foreach ($languages as $language){
                                                ?> 
                                                <a class="dropdown-item" href="../controller/edit_staff.php?lang=<?php echo $language['language_code']; ?>&id=<?php echo $staff['staff_id']; ?>"><?php echo $language['language_name']; ?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                ...
                                <td align="left" width="50px" class="padding-left-0">
                                  <a class="btn btn-small btn-danger btn-delete deleteItem" data-url="../controller/delete_staff.php?id=<?php echo $staff['staff_id']; ?>">
