...
<fieldset>
  ...
  <table class="display table t-table">
   ...
   <tr>  
     <td>
       <input type="text" value="<?php echo $translation['tr_201']; ?>" name="tr_201" class="form-control">
     </td>
   </tr>

   <tr>  
     <td>
       <input type="text" value="<?php echo $translation['tr_202']; ?>" name="tr_202" class="form-control">
     </td>
   </tr>

   <tr>  
     <td>
       <input type="text" value="<?php echo $translation['tr_203']; ?>" name="tr_203" class="form-control">
     </td>
   </tr>

   <tr>  
     <td>
       <input type="text" value="<?php echo $translation['tr_204']; ?>" name="tr_204" class="form-control">
     </td>
   </tr>

   <tr>  
     <td>
       <input type="text" value="<?php echo $translation['tr_205']; ?>" name="tr_205" class="form-control">
     </td>
   </tr>
