...
<div class="form-row">
  <div class="form-group col-md-9">
   ...
   <input type="text" value="" placeholder="" name="service_icon" class="form-control">
   ...
   <textarea type="text" value="" placeholder="" name="tr_description" class="advancedtinymce form-control"></textarea>
...
<div class="new-image" id="image-preview">
  ...
  <input type="file" name="service_image" id="image-upload" required="" />
</div>
