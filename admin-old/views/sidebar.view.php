<nav id="navigation" class="navigation-sidebar navbar-expand-lg static-top bg-primary">
        ...
        <a href="<?php echo SITE_URL ?>/admin"><img src="../assets/images/logo-white.png" class="logo-side"></a>
    </div>
    ...
    <div class="navigation-menu">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="../controller/services.php">
                            <span class="icon-thumbnail"><i class="dripicons-minus"></i></span>
                            <span class="title"><?php echo _SERVICES; ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="../controller/certificates.php">
                            <span class="icon-thumbnail"><i class="dripicons-minus"></i></span>
                            <span class="title"><?php echo _PAGECERTIFICATES; ?></span>
                        </a>
                    </li>
            ...
            <div class="container-fluid side-padding">
                <div class="row">
                    <div class="col-7 col-md-6 d-lg-none">
                        ...
                        <img src="../assets/images/logo.png" class="logo-side-dark">
                    </div>
