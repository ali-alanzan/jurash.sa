...
<div class="uk-text-center ev-section-margin-v-m">
	<a href="<?php echo SITE_URL.'/'.strtolower(echoOutput($translation['tr_200']));?>" class="uk-button uk-button-large uk-button-primary uk-border-pill"><?php echo echoOutput($translation['tr_202'])?></a>
</div>
