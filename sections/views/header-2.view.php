...
<a href="mailto:<?php echo $settings['st_email']; ?>"><?php echo $settings['st_email']; ?></a></p>
</div>
</div>
</div>
</div>
...
<p class="uk-text-meta uk-margin-remove-top"><a href="https://www.google.com/maps/search/?api=1&query=مجموعة جرش العقارية ، الامام محمد بن سعود ، الخالدية ، خميس مشيط-62461" target="_blank"><?php echo $lang == 'ar'?$settings['st_arabic_officeaddress']:$settings['st_officeaddress']; ?></a></p>
</div>
</div>
</div>
</div>
