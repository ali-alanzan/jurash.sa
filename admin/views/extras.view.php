                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                    <?php foreach($extras as $ex): ?>
                      <tr>
                       <td><?php echo $ex['pt_extra_id']; ?></td>
                       <td><?php echo echoOutput($ex['tr_name']); ?></td>
                       <td align="right" width="50px" class="padding-right-5">
                        ...
                        <div class="dropdown listing-page">
                          ...
                          <div class="dropdown-menu" aria-label="dropdownMenuButton">
                            ...
                            <?php
                            $id_extra = $ex['pt_extra_id'];
                            $languages = get_languages_by_extra($connect, $id_extra);

                            foreach ($languages as $language){
                              ?> 
                              <a class="dropdown-item" href="../controller/edit_extra.php?lang=<?php echo $language['language_code']; ?>&id=<?php echo $ex['pt_extra_id']; ?>"><?php echo $language['language_name']; ?></a>
                            <?php } ?>
                          </div>
                        </div>
                      ...
                      <td align="left" width="50px" class="padding-left-0">
                        <a class="btn btn-small btn-danger btn-delete deleteItem" data-url="../controller/delete_extra.php?id=<?php echo $ex['pt_extra_id']; ?>">
...
<div id="add_data_Modal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-body">
    <form enctype="multipart/form-data" method="post" id="insertExtra">
