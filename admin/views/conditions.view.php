            ...
            <div class="block table-block mb-4 c-4">
              ...
              <div class="row">
                <div class="table-responsive">
                  ...
                  <tbody>
                    <?php foreach($conditions as $st): ?>
                      <tr>
                       <td><?php echo $st['pt_conditions_id']; ?></td>
                       <td><?php echo echoOutput($st['tr_name']); ?></td>
                       <td align="right" width="50px" class="padding-right-5">
                        ...
                        <div class="dropdown listing-page">
                          ...
                          <div class="dropdown-menu" aria-label="dropdownMenuButton">
                            ...
                            <?php
                            $languages = get_languages_by_conditions($connect, $st['pt_conditions_id']);
                            foreach ($languages as $language){
                            ?> 
                            
                              <a class="dropdown-item" href="../controller/edit_conditions.php?lang=<?php echo $language['language_code']; ?>&id=<?php echo $st['pt_conditions_id']; ?>"><?php echo $language['language_name']; ?></a>
                            <?php } ?>
                          </div>
                        </div>
                      ...
                      <td align="left" width="50px" class="padding-left-0">
                        <a class="btn btn-small btn-danger btn-delete deleteItem" data-url="../controller/delete_conditions.php?id=<?php echo $st['pt_conditions_id']; ?>">
...
<div id="add_data_Modal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-body">
    <form enctype="multipart/form-data" method="post" id="insertConditions">
