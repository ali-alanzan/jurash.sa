                  ...
                  <tbody>
                    <?php foreach($types as $tp): ?>
                       ...
                       <td align="right" width="50px" class="padding-right-5">
                        ...
                        <div class="dropdown listing-page">
                          ...
                          <div class="dropdown-menu" aria-label="dropdownMenuButton">
                              ...
                              <?php $languages = get_languages_by_type($connect, $tp['pt_type_id']); ?>
                              <?php foreach($languages as $language): ?>

                                <a class="dropdown-item" href="../controller/edit_type.php?lang=<?php echo $language['language_code']; ?>&id=<?php echo $tp['pt_type_id']; ?>"><?php echo $language['language_name']; ?></a>
                              <?php endforeach; ?>
                      ...
                      <td align="left" width="50px" class="padding-left-0">
                        <a class="btn btn-small btn-danger btn-delete deleteItem" data-url="../controller/delete_type.php?id=<?php echo $tp['pt_type_id']; ?>">
