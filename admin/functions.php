...
function getPrice($price, $array){
    ...
    // Ensure the price is numeric, if not, return an empty string or handle it accordingly
    if (!is_numeric($price)) {
        return ''; // or you can handle the error case however you prefer
    }

    // Format the price based on the currency position
