...
$sqlQuery = "SELECT pt_cities.*,tr_ptcities.tr_name AS tr_name FROM pt_cities,tr_ptcities WHERE pt_cities.pt_city_id = tr_ptcities.tr_city AND tr_ptcities.tr_lang = '".getParamsLang()."' AND pt_cities.pt_city_featured = 1 GROUP BY pt_cities.pt_city_id";
}else{
